...
Motywy kursorów wzięte z kde-look. Ich autorzy to:
YCursors	Daniele Pighin
vox		Mike Bryant
Red Dot		uga
GKD		noonespecial
...
%description YCursors -l pl.UTF-8
...
%description Red_Dot -l pl.UTF-8
...
%description tuxshadow -l pl.UTF-8
